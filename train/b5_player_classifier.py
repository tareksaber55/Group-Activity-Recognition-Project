import yaml
from scripts.B5.b5_player_level_train import train 
from scripts.B5.b5_player_level_eval import evaluate
...
# select config path
config_path = 'configs/b5_player_classifier_config1.yaml'
...
train_dataset = PlayerLevelDataset(input_root,annot_file,categories_dict,train_ids,train_transform,one_frame=False)
val_dataset = PlayerLevelDataset(input_root,annot_file,categories_dict,val_ids,val_transform,one_frame=False)
test_dataset = PlayerLevelDataset(input_root,annot_file,categories_dict,test_ids,val_transform,one_frame=False)
