...
# select config path
config_path = 'configs/b3_playerclassifier_config1.yaml'
...
train_dataset = PlayerLevelDataset(input_root,annot_file,categories_dict,train_ids,train_transform,one_frame=True)
val_dataset = PlayerLevelDataset(input_root,annot_file,categories_dict,val_ids,val_transform,one_frame=True)
test_dataset = PlayerLevelDataset(input_root,annot_file,categories_dict,test_ids,val_transform,one_frame=True)
