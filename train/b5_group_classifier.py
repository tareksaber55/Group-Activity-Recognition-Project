import yaml
from scripts.B5.b5_group_level_train import train 
from scripts.B5.b5_group_level_eval import evaluate
from scripts.test_report import report
from utils.dataset import PlayerGroupDataset
from models.b5 import B5GroupClassifier,B5PlayerClassifier
import torch
...
# select config path
config_path = 'configs/b5_group_classifier_config1.yaml'
...
backbone.module.load_state_dict(state_dict=backbone_dict['model_state_dict'])
