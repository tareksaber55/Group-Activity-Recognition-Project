import yaml
from scripts.B8.b8_train import train 
from scripts.B8.b8_eval import evaluate
...
# select config path
config_path = 'configs/b8_config1.yaml'
...
# model
model = Baseline8(player_backbone=player_backbone,
